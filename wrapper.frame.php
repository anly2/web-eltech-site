...
function wrapper_frame_header($pad=''){
   ...
   echo $pad.'      <li><a href="index.php">Home</a></li>'."\n";
   echo $pad.'      <li><a href="about.php">About us</a></li>'."\n";
   echo $pad.'      <li><a href="gallery.php">Gallery</a></li>'."\n";
   echo $pad.'      <li><a href="?forum">Forum</a></li>'."\n";
   echo $pad.'      <li><a href="blog.php">Blog</a></li>'."\n";
   echo $pad.'   </ul>'."\n";
   echo $pad.'</div>'."\n";
}
